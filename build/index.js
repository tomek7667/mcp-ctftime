...
// Tools
server.registerTool("ctftime_events", {
    description: "List CTFtime events in a time window. Uses UNIX timestamps (seconds) for start/finish; returns past and upcoming events.",
    inputSchema: {
        limit: z
            .number()
            .int()
...
server.registerTool("ctftime_event", {
...
server.registerTool("ctftime_top_teams", {
...
server.registerTool("ctftime_top_by_country", {
...
server.registerTool("ctftime_team", {
...
server.registerTool("ctftime_results", {
...
server.registerTool("ctftime_votes", {
